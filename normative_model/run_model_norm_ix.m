function ker = run_model_norm_ix(reverb_X_fht,anechoic_X_ft,model,room_sz,dt_s)
...
total_s = 900;
jap_start_s = 0; jap_end_s = 270; val_sz_jap =  floor(val_chunk_sz*((jap_end_s-jap_start_s)./total_s)); %Japanese stim end s
nspeech_start_s = 270; nspeech_end_s = 630; val_sz_nspeech =  floor(val_chunk_sz*((nspeech_end_s-nspeech_start_s)./total_s)); %Non-speech stim end s
speech_start_s = 630; speech_end_s = 900; val_sz_speech =  floor(val_chunk_sz*((speech_end_s-speech_start_s)./total_s)); %Speech stim end s
