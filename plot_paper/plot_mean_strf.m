function plot_mean_strf(k_fhn,params)
%% Plotting params
freqs = params.freqs;
n_f = length(freqs);
n_h = params.n_h+1;
...
max_val = max(abs([k_hn_neg_mean_small(:);k_hn_pos_mean_small(:);k_hn_neg_mean_large(:);k_hn_pos_mean_large(:)]));
k_hn_neg_mean_small = k_hn_neg_mean_small/max_val;
k_hn_pos_mean_small = k_hn_pos_mean_small/max_val;
k_hn_neg_mean_large = k_hn_neg_mean_large/max_val;
k_hn_pos_mean_large = k_hn_pos_mean_large/max_val;
